...
Run the local faster-whisper baselines:
...
A valid Ultravox result should only be checked in after `make benchmark-compose-ultravox` completes successfully and produces a real artifact under `docs/benchmark-results/`.
