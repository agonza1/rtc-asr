...
async def demo_ready() -> dict[str, object]:
    ...
    return {
        ...
        "rtc_asr_max_buffer_seconds": config["rtc_asr_max_buffer_seconds"],
        "default_asr_model_option_id": config["default_asr_model_option_id"],
        ...
        "dependency_message": config["dependency_message"],
    }
