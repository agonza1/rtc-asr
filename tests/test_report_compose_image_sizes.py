...
def test_sort_records_orders_duplicate_image_ids_then_tag() -> None:
    records = [
        ...
        reporter.ImageSizeRecord(tag="unique:image", image_id="unique", size_bytes=100, created=None, present=True),
        reporter.ImageSizeRecord(tag="a-duplicate:image", image_id="shared", size_bytes=300, created=None, present=True),
        reporter.ImageSizeRecord(tag="missing:image", image_id=None, size_bytes=None, created=None, present=False),
        reporter.ImageSizeRecord(tag="unknown-id:image", image_id=None, size_bytes=400, created=None, present=True),
    ]

    assert [record.tag for record in reporter.sort_records(records, "duplicate-id-first")] == [
        "a-duplicate:image",
        "z-duplicate:image",
        "missing:image",
        "unique:image",
    ...
    assert [record.tag for record in reporter.sort_records(records, "unique-id-first")] == [
        "missing:image",
        "unique:image",
        "unknown-id:image",
        "a-duplicate:image",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("created_first", "created-desc"),
        ("as-listed", "input"),
        ("by-input", "input"),
        ("by_input_order", "input"),
        ("input_order", "input"),
        ("requested", "input"),
        ("by-name", "tag"),
        ("by_tag", "tag"),
        ...
        ("smallest_to_largest", "size-asc"),
        ("by_smallest", "size-asc"),
        ("smallest", "size-asc"),
        ("smallest_image", "size-asc"),
        ("lightest-first", "size-asc"),
        ("by-created", "created-desc"),
        ("by_created_desc", "created-desc"),
        ...
        ("oldest_to_newest", "created-asc"),
        ("by_created_asc", "created-asc"),
        ("oldest", "created-asc"),
        ...
        ("created_known_first", "known-created-first"),
        ...
        ("created_unknown_first", "unknown-created-first"),
        ...
        ("duplicate id", "duplicate-id-first"),
        ("duplicate_image_ids", "duplicate-id-first"),
        ("shared-id-first", "duplicate-id-first"),
        ("same-image-id", "duplicate-id-first"),
        ("unique-id", "unique-id-first"),
        ("unique_image_ids_first", "unique-id-first"),
        ("single_image_id_first", "unique-id-first"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("--size-budget", "max_size_mb"),
        ("--size-budget-mb", "max_size_mb"),
        ...
        ("--total-image-size-budget", "max_total_size_mb"),
        ...
        ("--max-unique-total-size-mb", "max_deduplicated_total_size_mb"),
        ("--max-unique-total-size", "max_deduplicated_total_size_mb"),
        ("--max-distinct-total-size-mb", "max_deduplicated_total_size_mb"),
        ("--max-distinct-total-size", "max_deduplicated_total_size_mb"),
        ("--deduplicated-total-budget", "max_deduplicated_total_size_mb"),
        ("--deduplicated-total-budget-mb", "max_deduplicated_total_size_mb"),
        ("--unique-total-size-budget", "max_deduplicated_total_size_mb"),
        ("--unique-total-size-budget-mb", "max_deduplicated_total_size_mb"),
        ("--distinct-total-budget", "max_deduplicated_total_size_mb"),
        ("--distinct-total-budget-mb", "max_deduplicated_total_size_mb"),
