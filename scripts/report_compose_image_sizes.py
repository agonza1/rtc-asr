...
SORT_ALIASES = {
    ...
    "present-images-last": "missing-first",
    "present-image-last": "missing-first",
    "available-last": "missing-first",
    "existing-last": "missing-first",
    ...
    "missing-images-last": "present-first",
    "missing-image-last": "present-first",
    "absent-last": "present-first",
    "unavailable-last": "present-first",
    ...
    "known-sizes-last": "unknown-size-first",
    "known-image-size-last": "unknown-size-first",
    "known-image-sizes-last": "unknown-size-first",
    "sized": "known-size-first",
    "sized-first": "known-size-first",
    "sized-last": "unknown-size-first",
    "sized-images": "known-size-first",
    "sized-images-first": "known-size-first",
    "sized-images-last": "unknown-size-first",
    ...
    "unknown-sizes-last": "known-size-first",
    "missing-size": "unknown-size-first",
    "missing-size-first": "unknown-size-first",
    "missing-size-last": "known-size-first",
    ...
    "created-known-last": "unknown-created-first",
    "known-creation-last": "unknown-created-first",
    "known-created-time-last": "unknown-created-first",
    "known-image-created-last": "unknown-created-first",
    "timestamped": "known-created-first",
    "timestamped-first": "known-created-first",
    "timestamped-last": "unknown-created-first",
    "dated": "known-created-first",
    "dated-first": "known-created-first",
    "dated-last": "unknown-created-first",
    ...
    "duplicate-ids-last": "unique-id-first",
    ...
    "duplicate-image-id-last": "unique-id-first",
    "duplicate-image-ids-last": "unique-id-first",
    "shared-id": "duplicate-id-first",
    "shared-ids": "duplicate-id-first",
    "shared-id-first": "duplicate-id-first",
    "shared-id-last": "unique-id-first",
    "shared-ids-last": "unique-id-first",
    ...
    "unique-image-id-last": "duplicate-id-first",
    "unique-image-ids-last": "duplicate-id-first",
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        "--max-unique-total-size-mb",
        "--max-unique-total-size",
        "--max-distinct-total-size-mb",
        "--max-distinct-total-size",
        "--deduplicated-total-budget",
        "--deduplicated-total-budget-mb",
        "--unique-total-size-budget",
        "--unique-total-size-budget-mb",
        "--distinct-total-budget",
        "--distinct-total-budget-mb",
        "--dedupe-total-budget",
