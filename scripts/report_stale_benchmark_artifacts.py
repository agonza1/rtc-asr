...
SUMMARY_GROUP_ALIASES = {
    ...
    "file-suffix": "artifact-extension",
    "artifact-basename": "artifact-name",
    "artifact-filename": "artifact-name",
    "artifact-file-path": "artifact-path",
    ...
    "artifact-path-suffix": "artifact-extension",
    "artifact-path-file-ext": "artifact-extension",
    "artifact-path-file-extension": "artifact-extension",
    "artifact-path-file-suffix": "artifact-extension",
    "current-path": "current-artifact",
    "current-artifact-path": "current-artifact",
    "current-file-path": "current-artifact",
    "current-artifact-file-path": "current-artifact",
    ...
    "artifact-suffix": "artifact-extension",
    "artifact-file-suffix": "artifact-extension",
    "current-extension": "current-artifact-extension",
    "current-ext": "current-artifact-extension",
    "current-suffix": "current-artifact-extension",
    ...
    "current-artifact-suffix": "current-artifact-extension",
    "current-artifact-file-suffix": "current-artifact-extension",
    "current-file-ext": "current-artifact-extension",
    "current-file-extension": "current-artifact-extension",
    "current-file-suffix": "current-artifact-extension",
    ...
    "current-path-suffix": "current-artifact-extension",
    "current-path-file-suffix": "current-artifact-extension",
    "detail-extension": "detail-page-extension",
    "detail-ext": "detail-page-extension",
    "detail-suffix": "detail-page-extension",
    "detail-file-ext": "detail-page-extension",
    "detail-file-extension": "detail-page-extension",
    "detail-file-suffix": "detail-page-extension",
    "detail-page-ext": "detail-page-extension",
    "detail-page-suffix": "detail-page-extension",
    "detail-path": "detail-page",
    "detail-page-path": "detail-page",
    "detail-file-path": "detail-page",
    "detail-page-file-path": "detail-page",
    ...
    "measured-on-week": "measured-week",
    "date": "measured-day",
    ...
    "measured-on": "measured-day",
    "measured-on-day": "measured-day",
    "measured-on-date": "measured-day",
    "measured-date": "measured-day",
    "measured-at-date": "measured-day",
    "measured-at-day": "measured-day",
    "age-range": "age-bucket",
    "age-ranges": "age-bucket",
    "age-range-bucket": "age-bucket",
    "age-range-buckets": "age-bucket",
    "age-buckets": "age-bucket",
    "stale-age-bucket": "age-bucket",
    "stale-age-buckets": "age-bucket",
    "staleness-bucket": "age-bucket",
    "staleness-buckets": "age-bucket",
}
...
STALE_SORT_ALIASES = {
    ...
    "newest-to-oldest": "measured-at-desc",
    ...
    "measured-on-year": "measured-year",
    "measured-on-year-asc": "measured-year-asc",
    "measured-on-year-desc": "measured-year-desc",
    "quarter": "measured-quarter",
    ...
    "measured-on-quarter": "measured-quarter",
    "measured-on-quarter-asc": "measured-quarter-asc",
    "measured-on-quarter-desc": "measured-quarter-desc",
    "month": "measured-month",
    ...
    "measured-on-month": "measured-month",
    "measured-on-month-asc": "measured-month-asc",
    "measured-on-month-desc": "measured-month-desc",
    "week": "measured-week",
    ...
    "measured-on-week": "measured-week",
    "measured-on-week-asc": "measured-week-asc",
    "measured-on-week-desc": "measured-week-desc",
    "date": "measured-day",
    ...
    "measured-on": "measured-day",
    "measured-on-asc": "measured-day-asc",
    "measured-on-desc": "measured-day-desc",
    "measured-on-day": "measured-day",
    "measured-on-day-asc": "measured-day-asc",
    "measured-on-day-desc": "measured-day-desc",
    "measured-on-date": "measured-day",
    "measured-on-date-asc": "measured-day-asc",
    "measured-on-date-desc": "measured-day-desc",
    "measured-date": "measured-day",
    ...
    "age-ranges": "age-bucket",
    "age-ranges-asc": "age-bucket-asc",
    "age-ranges-desc": "age-bucket-desc",
    "age-range-bucket": "age-bucket",
    "age-range-bucket-asc": "age-bucket-asc",
    "age-range-bucket-desc": "age-bucket-desc",
    "age-range-buckets": "age-bucket",
    "age-range-buckets-asc": "age-bucket-asc",
    "age-range-buckets-desc": "age-bucket-desc",
    "age-buckets": "age-bucket",
    "age-buckets-asc": "age-bucket-asc",
    "age-buckets-desc": "age-bucket-desc",
    "stale-age-bucket": "age-bucket",
    "stale-age-bucket-asc": "age-bucket-asc",
    "stale-age-bucket-desc": "age-bucket-desc",
    "stale-age-buckets": "age-bucket",
    "stale-age-buckets-asc": "age-bucket-asc",
    "stale-age-buckets-desc": "age-bucket-desc",
    "staleness-bucket": "age-bucket",
    "staleness-bucket-asc": "age-bucket-asc",
    "staleness-bucket-desc": "age-bucket-desc",
    "staleness-buckets": "age-bucket",
    "staleness-buckets-asc": "age-bucket-asc",
    "staleness-buckets-desc": "age-bucket-desc",
    ...
    "path-suffix": "artifact-extension",
    "path-suffix-asc": "artifact-extension-asc",
    "path-suffix-desc": "artifact-extension-desc",
    "path-file-ext": "artifact-extension",
    ...
    "path-file-suffix": "artifact-extension",
    "path-file-suffix-asc": "artifact-extension-asc",
    "path-file-suffix-desc": "artifact-extension-desc",
    ...
    "filename": "artifact-name",
    "filename-asc": "artifact-name-asc",
    "filename-desc": "artifact-name-desc",
    "file-name": "artifact-name",
    "file-name-asc": "artifact-name-asc",
    "file-name-desc": "artifact-name-desc",
    "basename": "artifact-name",
    "basename-asc": "artifact-name-asc",
    "basename-desc": "artifact-name-desc",
    "file-stem": "artifact-stem",
    "file-stem-asc": "artifact-stem-asc",
    "file-stem-desc": "artifact-stem-desc",
    "stem": "artifact-stem",
    "stem-asc": "artifact-stem-asc",
    "stem-desc": "artifact-stem-desc",
    "directory": "artifact-dir",
    "directory-asc": "artifact-dir-asc",
    "directory-desc": "artifact-dir-desc",
    "dirname": "artifact-dir",
    "dirname-asc": "artifact-dir-asc",
    "dirname-desc": "artifact-dir-desc",
    "folder": "artifact-dir",
    "folder-asc": "artifact-dir-asc",
    "folder-desc": "artifact-dir-desc",
    "folder-name": "artifact-dir",
    "folder-name-asc": "artifact-dir-asc",
    "folder-name-desc": "artifact-dir-desc",
    "extension": "artifact-extension",
    "extension-asc": "artifact-extension-asc",
    "extension-desc": "artifact-extension-desc",
    "ext": "artifact-extension",
    "ext-asc": "artifact-extension-asc",
    "ext-desc": "artifact-extension-desc",
    "suffix": "artifact-extension",
    "suffix-asc": "artifact-extension-asc",
    "suffix-desc": "artifact-extension-desc",
    "file-ext": "artifact-extension",
    "file-ext-asc": "artifact-extension-asc",
    "file-ext-desc": "artifact-extension-desc",
    "file-extension": "artifact-extension",
    "file-extension-asc": "artifact-extension-asc",
    "file-extension-desc": "artifact-extension-desc",
    "file-suffix": "artifact-extension",
    "file-suffix-asc": "artifact-extension-asc",
    "file-suffix-desc": "artifact-extension-desc",
    "artifact-ext": "artifact-extension",
    "artifact-ext-asc": "artifact-extension-asc",
    "artifact-ext-desc": "artifact-extension-desc",
    "artifact-suffix": "artifact-extension",
    "artifact-suffix-asc": "artifact-extension-asc",
    "artifact-suffix-desc": "artifact-extension-desc",
    "artifact-file-ext": "artifact-extension",
    ...
    "artifact-file-suffix": "artifact-extension",
    "artifact-file-suffix-asc": "artifact-extension-asc",
    "artifact-file-suffix-desc": "artifact-extension-desc",
    "artifact-path-extension": "artifact-extension",
    ...
    "artifact-path-suffix": "artifact-extension",
    "artifact-path-suffix-asc": "artifact-extension-asc",
    "artifact-path-suffix-desc": "artifact-extension-desc",
    "artifact-path-file-ext": "artifact-extension",
    ...
    "artifact-path-file-suffix": "artifact-extension",
    "artifact-path-file-suffix-asc": "artifact-extension-asc",
    "artifact-path-file-suffix-desc": "artifact-extension-desc",
    ...
    "current-suffix": "current-path-extension",
    "current-suffix-asc": "current-path-extension-asc",
    "current-suffix-desc": "current-path-extension-desc",
    "current-artifact-ext": "current-path-extension",
    "current-artifact-ext-asc": "current-path-extension-asc",
    "current-artifact-ext-desc": "current-path-extension-desc",
    "current-artifact-file-ext": "current-path-extension",
    ...
    "current-artifact-file-extension-asc": "current-path-extension-asc",
    "current-artifact-file-extension-desc": "current-path-extension-desc",
    "current-artifact-suffix": "current-path-extension",
    "current-artifact-suffix-asc": "current-path-extension-asc",
    "current-artifact-suffix-desc": "current-path-extension-desc",
    "current-artifact-file-suffix": "current-path-extension",
    "current-artifact-file-suffix-asc": "current-path-extension-asc",
    "current-artifact-file-suffix-desc": "current-path-extension-desc",
    ...
    "current-file-suffix": "current-path-extension",
    "current-file-suffix-asc": "current-path-extension-asc",
    "current-file-suffix-desc": "current-path-extension-desc",
    ...
    "current-path-suffix": "current-path-extension",
    "current-path-suffix-asc": "current-path-extension-asc",
    "current-path-suffix-desc": "current-path-extension-desc",
    "current-path-file-suffix": "current-path-extension",
    "current-path-file-suffix-asc": "current-path-extension-asc",
    "current-path-file-suffix-desc": "current-path-extension-desc",
    "detail-path": "detail-page",
    ...
    "detail-suffix": "detail-page-extension",
    "detail-suffix-asc": "detail-page-extension-asc",
    "detail-suffix-desc": "detail-page-extension-desc",
    "detail-file-ext": "detail-page-extension",
    ...
    "detail-file-suffix": "detail-page-extension",
    "detail-file-suffix-asc": "detail-page-extension-asc",
    "detail-file-suffix-desc": "detail-page-extension-desc",
    "detail-page-ext": "detail-page-extension",
    "detail-page-ext-asc": "detail-page-extension-asc",
    "detail-page-ext-desc": "detail-page-extension-desc",
    "detail-page-suffix": "detail-page-extension",
    "detail-page-suffix-asc": "detail-page-extension-asc",
    "detail-page-suffix-desc": "detail-page-extension-desc",
    "detail-page-file-ext": "detail-page-extension",
    ...
    "detail-page-file-suffix": "detail-page-extension",
    "detail-page-file-suffix-asc": "detail-page-extension-asc",
    "detail-page-file-suffix-desc": "detail-page-extension-desc",
}
...
SUMMARY_SORTS = (
    ...
    "age-range-buckets",
    "age-range-buckets-desc",
    "age-range-buckets-asc",
    "age-buckets",
    "age-buckets-desc",
    "age-buckets-asc",
    "stale-age-bucket",
    ...
    "stale-age-buckets",
    "stale-age-buckets-desc",
    "stale-age-buckets-asc",
    "staleness-bucket",
    "staleness-bucket-desc",
    "staleness-bucket-asc",
    "staleness-buckets",
    "staleness-buckets-desc",
    "staleness-buckets-asc",
    "age",
    "age-desc",
    "age-asc",
    "older",
    ...
    "measured-on-year",
    "measured-on-year-desc",
    "measured-on-year-asc",
    "measured-year",
    "measured-year-desc",
    "measured-year-asc",
    "quarter",
    ...
    "measured-on-quarter",
    "measured-on-quarter-desc",
    "measured-on-quarter-asc",
    "measured-quarter",
    ...
    "measured-on-month",
    "measured-on-month-desc",
    "measured-on-month-asc",
    "measured-month",
    "measured-month-desc",
    "measured-month-asc",
    "date",
    ...
    "measured-on-week",
    "measured-on-week-desc",
    "measured-on-week-asc",
    "measured-week",
    "measured-week-desc",
    "measured-week-asc",
)
...
SUMMARY_SORT_ALIASES = {
    ...
    "age-range-desc": "age-bucket-desc",
    "age-range-asc": "age-bucket-asc",
    "age-ranges": "age-bucket-desc",
    "age-ranges-desc": "age-bucket-desc",
    "age-ranges-asc": "age-bucket-asc",
    "age-range-bucket": "age-bucket-desc",
    "age-range-bucket-desc": "age-bucket-desc",
    "age-range-bucket-asc": "age-bucket-asc",
    "age-range-buckets": "age-bucket-desc",
    "age-range-buckets-desc": "age-bucket-desc",
    "age-range-buckets-asc": "age-bucket-asc",
    "age-buckets": "age-bucket-desc",
    "age-buckets-desc": "age-bucket-desc",
    "age-buckets-asc": "age-bucket-asc",
    "stale-age-bucket": "age-bucket-desc",
    "stale-age-bucket-desc": "age-bucket-desc",
    "stale-age-bucket-asc": "age-bucket-asc",
    "stale-age-buckets": "age-bucket-desc",
    "stale-age-buckets-desc": "age-bucket-desc",
    "stale-age-buckets-asc": "age-bucket-asc",
    "staleness-bucket": "age-bucket-desc",
    "staleness-bucket-desc": "age-bucket-desc",
    "staleness-bucket-asc": "age-bucket-asc",
    "staleness-buckets": "age-bucket-desc",
    "staleness-buckets-desc": "age-bucket-desc",
    "staleness-buckets-asc": "age-bucket-asc",
    "age": "age-bucket-desc",
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        choices=(
            ...
            "artifact-file-suffix-asc",
            "artifact-file-suffix-desc",
            "artifact-extension",
            ...
            "detail-file-suffix",
            "detail-file-suffix-asc",
            "detail-file-suffix-desc",
            "detail-page-ext",
            "detail-page-ext-asc",
            "detail-page-ext-desc",
            "detail-page-suffix",
            "detail-page-suffix-asc",
            "detail-page-suffix-desc",
            ...
            "artifact-path-suffix-asc",
            "artifact-path-suffix-desc",
            ...
            "artifact-path-file-suffix",
            "artifact-path-file-suffix-asc",
            "artifact-path-file-suffix-desc",
            "status",
            "status-asc",
            "status-desc",
            "backend",
            ...
            "current-path-suffix",
            "current-path-suffix-asc",
            "current-path-suffix-desc",
            ...
            "current-artifact-suffix",
            "current-artifact-suffix-asc",
            "current-artifact-suffix-desc",
            "current-artifact-file-suffix",
            "current-artifact-file-suffix-asc",
            "current-artifact-file-suffix-desc",
            "current-file-ext",
            ...
            "current-file-suffix",
            "current-file-suffix-asc",
            "current-file-suffix-desc",
    ...
    parser.add_argument(
        ...
        "--current-path-stems-contains",
        "--current-artifact-stem-contains",
        "--current-artifact-stems-contains",
        "--current-artifact-file-stem-contains",
        "--current-artifact-file-stems-contains",
    ...
    parser.add_argument(
        ...
        "--current-dirs",
        "--current-path-dirname",
        "--current-path-dirnames",
        "--current-artifact-dirname",
        "--current-artifact-dirnames",
        "--current-dirname",
        "--current-dirnames",
        "--current-path-folder",
        ...
        "--current-folders",
        "--current-path-folder-name",
        "--current-path-folder-names",
        "--current-artifact-folder-name",
        "--current-artifact-folder-names",
        "--current-folder-name",
    ...
    parser.add_argument(
        ...
        "--current-path-exts",
        "--current-path-file-ext",
        "--current-path-file-exts",
        "--current-path-file-extension",
        "--current-path-file-extensions",
        "--current-path-suffix",
        "--current-path-suffixes",
        "--current-path-file-suffix",
        "--current-path-file-suffixes",
        "--current-artifact-ext",
        "--current-artifact-exts",
        "--current-artifact-file-ext",
        "--current-artifact-file-exts",
        "--current-artifact-file-extension",
        "--current-artifact-file-extensions",
        "--current-artifact-suffix",
        "--current-artifact-suffixes",
        "--current-artifact-file-suffix",
        "--current-artifact-file-suffixes",
        "--current-file-ext",
        "--current-file-exts",
        "--current-file-extension",
    ...
    parser.add_argument(
        ...
        "--current-path-extensions-contains",
        "--current-artifact-extension-contains",
        "--current-artifact-extensions-contains",
        "--current-extension-contains",
        "--current-extensions-contains",
        "--current-ext-contains",
        "--current-exts-contains",
        "--current-suffix-contains",
        "--current-suffixes-contains",
        "--current-path-ext-contains",
        "--current-path-exts-contains",
        "--current-path-file-ext-contains",
        "--current-path-file-exts-contains",
        "--current-path-file-extension-contains",
        "--current-path-file-extensions-contains",
        "--current-path-suffix-contains",
        "--current-path-suffixes-contains",
        "--current-path-file-suffix-contains",
        "--current-path-file-suffixes-contains",
        "--current-artifact-ext-contains",
        "--current-artifact-exts-contains",
        "--current-artifact-file-ext-contains",
        "--current-artifact-file-exts-contains",
        "--current-artifact-file-extension-contains",
        "--current-artifact-file-extensions-contains",
        "--current-artifact-suffix-contains",
        "--current-artifact-suffixes-contains",
        "--current-artifact-file-suffix-contains",
        "--current-artifact-file-suffixes-contains",
        "--current-file-ext-contains",
        "--current-file-exts-contains",
        "--current-file-extension-contains",
        "--current-file-extensions-contains",
        "--current-file-suffix-contains",
        "--current-file-suffixes-contains",
        action="append",
        default=None,
    ...
    parser.add_argument(
        ...
        "--detail-basenames",
        "--detail-page-basename",
        "--detail-page-basenames",
        "--detail-filename",
        "--detail-filenames",
        "--detail-page-filename",
        "--detail-page-filenames",
        "--detail-file-name",
        "--detail-file-names",
        "--detail-page-file-name",
        "--detail-page-file-names",
        action="append",
        default=None,
    ...
    parser.add_argument(
        ...
        "--detail-directories",
        "--detail-page-directory",
        "--detail-page-directories",
        "--detail-dirname",
        "--detail-dirnames",
        "--detail-page-dirname",
        "--detail-page-dirnames",
        "--detail-folder",
        "--detail-folders",
        "--detail-page-folder",
        "--detail-page-folders",
    ...
    parser.add_argument(
        ...
        "--detail-page-dirs-contains",
        "--detail-dir-contains",
        "--detail-dirs-contains",
        "--detail-directory-contains",
        "--detail-directories-contains",
        "--detail-page-directory-contains",
        "--detail-page-directories-contains",
        "--detail-dirname-contains",
        "--detail-dirnames-contains",
        "--detail-page-dirname-contains",
        "--detail-page-dirnames-contains",
        "--detail-folder-contains",
        "--detail-folders-contains",
        "--detail-page-folder-contains",
        "--detail-page-folders-contains",
        "--detail-folder-name-contains",
        "--detail-folder-names-contains",
        "--detail-page-folder-name-contains",
        "--detail-page-folder-names-contains",
        action="append",
        default=None,
    ...
    parser.add_argument(
        ...
        "--detail-file-exts",
        "--detail-file-extension",
        "--detail-file-extensions",
        "--detail-file-suffix",
        "--detail-file-suffixes",
        "--detail-page-ext",
        "--detail-page-exts",
        "--detail-page-suffix",
        "--detail-page-suffixes",
        "--detail-page-file-ext",
        "--detail-page-file-exts",
        "--detail-page-file-extension",
        "--detail-page-file-extensions",
        "--detail-page-file-suffix",
        "--detail-page-file-suffixes",
        action="append",
        default=None,
    ...
    parser.add_argument(
        ...
        "--detail-page-extensions-contains",
        "--detail-extension-contains",
        "--detail-extensions-contains",
        "--detail-ext-contains",
        "--detail-exts-contains",
        "--detail-suffix-contains",
        "--detail-suffixes-contains",
        "--detail-file-ext-contains",
        "--detail-file-exts-contains",
        "--detail-file-extension-contains",
        "--detail-file-extensions-contains",
        "--detail-file-suffix-contains",
        "--detail-file-suffixes-contains",
        "--detail-page-ext-contains",
        "--detail-page-exts-contains",
        "--detail-page-suffix-contains",
        "--detail-page-suffixes-contains",
        "--detail-page-file-ext-contains",
        "--detail-page-file-exts-contains",
        "--detail-page-file-extension-contains",
        "--detail-page-file-extensions-contains",
        "--detail-page-file-suffix-contains",
        "--detail-page-file-suffixes-contains",
        action="append",
        default=None,
