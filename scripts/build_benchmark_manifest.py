...
def normalized_contract_transport(value: Any) -> Any:
    ...
    aliases = {
        ...
        "raw domain socket transport": "raw_uds",
        "uds raw": "raw_uds",
        "uds raw transport": "raw_uds",
        "uds raw socket": "raw_uds",
        "uds raw socket transport": "raw_uds",
        "uds unix": "raw_uds",
        "uds unix socket": "raw_uds",
        "uds unix socket transport": "raw_uds",
        "unix raw": "raw_uds",
        "unix raw socket": "raw_uds",
        "unix raw domain": "raw_uds",
        "unix raw domain socket": "raw_uds",
        "unix domain raw": "raw_uds",
        ...
        "uds": "uds_ws",
        "uds transport": "uds_ws",
        "uds websocket": "uds_ws",
        "uds websocket transport": "uds_ws",
        "uds ws": "uds_ws",
        "websocket uds": "uds_ws",
        "websocket unix": "uds_ws",
        "websocket unix socket": "uds_ws",
        "websocket unix domain socket": "uds_ws",
        "websocket unix domain socket transport": "uds_ws",
        "ws uds": "uds_ws",
        "ws unix": "uds_ws",
        "ws unix socket": "uds_ws",
        "unix socket": "uds_ws",
        "unix socket transport": "uds_ws",
        "unix domain socket": "uds_ws",
        "unix domain socket transport": "uds_ws",
        "unix domain ws": "uds_ws",
        "unix domain websocket": "uds_ws",
        "unix domain websocket transport": "uds_ws",
        "unix domain socket websocket": "uds_ws",
        "unix domain socket websocket transport": "uds_ws",
        "unix domain socket web socket": "uds_ws",
        "unix domain socket web socket transport": "uds_ws",
        "unix domain socket ws": "uds_ws",
        "unix domain socket ws transport": "uds_ws",
        "unix websocket": "uds_ws",
        "unix websocket transport": "uds_ws",
        "unix ws": "uds_ws",
        "domain socket websocket": "uds_ws",
        "domain socket websocket transport": "uds_ws",
        "domain socket web socket": "uds_ws",
        "domain socket web socket transport": "uds_ws",
        "domain socket ws": "uds_ws",
        "domain socket ws transport": "uds_ws",
        "tcp websocket": "tcp_ws",
        "tcp websocket transport": "tcp_ws",
        "tcp web socket": "tcp_ws",
        "tcp web socket transport": "tcp_ws",
        "tcp ws": "tcp_ws",
        "tcp wss": "tcp_ws",
        "web socket": "tcp_ws",
        ...
        "secure web socket transport": "tcp_ws",
        "tcp secure websocket": "tcp_ws",
        "tcp secure websocket transport": "tcp_ws",
        "tcp secure web socket": "tcp_ws",
        "tcp secure web socket transport": "tcp_ws",
...
def extract_system_signals(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "memory_total_mb": first_defined(
            ...
            environment.get("total_memory_mb"),
            environment.get("system_ram_mb"),
            environment.get("ram_total_mb"),
            system.get("memory_total_mb"),
            system.get("total_memory_mb"),
            system.get("system_ram_mb"),
            system.get("ram_total_mb"),
            metrics.get("memory_total_mb"),
            metrics.get("total_memory_mb"),
            metrics.get("system_ram_mb"),
            metrics.get("ram_total_mb"),
            memory.get("total_mb"),
            memory.get("total_memory_mb"),
            memory.get("system_ram_mb"),
            memory.get("ram_total_mb"),
            nested_value(metrics, "memory", "total_mb"),
            nested_value(metrics, "memory", "total_memory_mb"),
            nested_value(metrics, "memory", "system_ram_mb"),
            nested_value(metrics, "memory", "ram_total_mb"),
        ),
        ...
        "cpu_utilization_percent": first_defined(
            ...
            environment.get("cpu_usage_percent"),
            system.get("cpu_utilization_percent"),
            system.get("cpu_percent"),
            system.get("cpu_usage_percent"),
            ...
            nested_value(metrics, "cpu", "usage_percent"),
        ...
        "package_power_watts": first_defined(
            ...
            nested_value(metrics, "power", "package_power_mean_watts"),
            ...
            power.get("package_power_mean_watts"),
        ...
        "thermal_peak_celsius": first_defined(
            ...
            nested_value(metrics, "thermal", "peak_temp_c"),
...
def summarize_warnings(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if total is not None and reported_sample_count == 0:
        reported_sample_count = sample_count(payload)

    rate_per_sample = None
    if total is not None and reported_sample_count:
        rate_per_sample = total / reported_sample_count
...
def build_system_coverage(entries: list[dict[str, Any]]) -> dict[str, int]:
    return {
        ...
        "process_metrics_pid_count": sum(
            1 for entry in entries if entry["system"].get("process_metrics_pid") is not None
        ),
...
def build_transport_coverage_summary(entries: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    for entry in entries:
        contract = entry.get("contract") or {}
        streaming = entry.get("streaming") or {}
        transport = contract.get("transport") or streaming.get("transport") or "unknown"
        path = contract.get("path") or "unknown"
        by_transport[str(transport)] = by_transport.get(str(transport), 0) + 1
...
def build_manifest(results_dir: Path, tracks_path: Path = DEFAULT_TRACKS_PATH) -> dict[str, Any]:
    ...
    summary = {
        ...
        "transport_coverage": build_transport_coverage_summary(artifact_history),
