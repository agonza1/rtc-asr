...
def normalized_transport(artifact: dict[str, Any]) -> str | None:
    ...
    value = first_defined(
        ...
        target.get("transportType"),
        target.get("transport_mode"),
        target.get("transportMode"),
        target.get("socket_mode"),
        target.get("socketMode"),
        target.get("mode"),
        contract.get("transport"),
        contract.get("transport_type"),
        contract.get("transportType"),
        contract.get("transport_mode"),
        contract.get("transportMode"),
        contract.get("socket_mode"),
        contract.get("socketMode"),
        contract.get("mode"),
        integration.get("transport"),
        integration.get("transport_type"),
        integration.get("transportType"),
        integration.get("transport_mode"),
        integration.get("transportMode"),
        integration.get("socket_mode"),
        integration.get("socketMode"),
        integration.get("mode"),
        streaming.get("transport"),
        streaming.get("transport_type"),
        streaming.get("transportType"),
        streaming.get("transport_mode"),
        streaming.get("transportMode"),
        streaming.get("socket_mode"),
        streaming.get("socketMode"),
        streaming.get("mode"),
        benchmark.get("transport"),
        benchmark.get("transport_type"),
        benchmark.get("transportType"),
        benchmark.get("transport_mode"),
        benchmark.get("transportMode"),
        benchmark.get("socket_mode"),
        benchmark.get("socketMode"),
        benchmark.get("mode"),
